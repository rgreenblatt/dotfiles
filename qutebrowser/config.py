...
## Type: Dict
c.aliases = {'wq': 'quit --save', 'q': 'close', 'w': 'session-save', 'wqa': 'quit --save', 'qa': 'quit'}
...
## Type: Dict
c.bindings.key_mappings = {'<Shift-Return>': '<Return>', '<Ctrl-6>': '<Ctrl-^>', '<Enter>': '<Return>', 
        '<Ctrl-M>': '<Return>', '<Ctrl-J>': '<Return>', '<Ctrl-[>': '<Escape>', '<Shift-Enter>': 
...
## for transparency.
## Type: QssColor
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255, 247, 133, 0.8),' + \
...
##   - no-3rdparty: Accept cookies from the same origin only. This is known to break some sites, such as
##       GMail.
##   - no-unknown-3rdparty: Accept cookies from the same origin only, unless a cookie is already set for the 
##       domain. On QtWebEngine, this is the same as no-3rdparty.
...
## Type: Dict
c.content.javascript.log = {'warning': 'debug', 'error': 'debug', 'unknown': 'debug', 'info': 'debug'}
...
## Type: ShellCommand
c.editor.command = ['terminator', '-x', 'vim', '-f', '{file}', '-c', 'normal {line}G{column0}l']
...
## hints.
## Type: Dict
c.hints.selectors = {'inputs': ['input[type="text"]', 'input[type="date"]', 'input[type="datetime-local"]', 'input[type="email"]', 'input[type="month"]', 'input[type="number"]', 'input[type="password"]', 'input[type="search"]', 'input[type="tel"]', 'input[type="time"]', 'input[type="url"]', 'input[type="week"]', 'input:not([type])', 'textarea'], 'images': ['img'], 'links': ['a[href]', 'area[href]', 'link[href]', '[role="link"][href]'], 'media': ['audio', 'img', 'video'], 'all': ['a', 'area', 'textarea', 'select', 'input:not([type="hidden"])', 'button', 'frame', 'iframe', 'img', 'link', 'summary', '[onclick]', '[onmousedown]', '[role="link"]', '[role="option"]', '[role="button"]', '[ng-click]', '[ngClick]', '[data-ng-click]', '[x-ng-click]', '[tabindex]'], 'url': ['[src]', '[href]']}
...
## Type: Padding
c.tabs.padding = {'top': 0, 'right': 5, 'bottom': 0, 'left': 5}
...
config.bind('<Ctrl-b>', 'open-editor', mode='insert')
