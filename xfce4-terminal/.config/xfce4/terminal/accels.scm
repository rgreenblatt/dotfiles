...
;
(gtk_accel_path "<Actions>/terminal-window/copy" "<Ctrl><Shift>c")
(gtk_accel_path "<Actions>/terminal-window/paste" "<Ctrl><Shift>v")
(gtk_accel_path "<Actions>/terminal-window/zoom-in" "<Ctrl><Shift>q")
